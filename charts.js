...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var resultArray = samples.filter(i => i.id == sample);
    ...
    var bubble_otu_ids = result.otu_ids;
    var bubble_otu_labels = result.otu_labels;
    var bubble_sample_values = result.sample_values;
    ...
    var resultMetaArray = data.metadata.filter(i => i.id == sample);
